...
2. **Manifest before any vote.** Output one chat message containing, for EVERY pending item, a four-point plain-English card: **what changes** (no jargon), **why it's needed** (the friction or gap it solves), **before vs. after** (what stays true today if rejected, what becomes true if adopted), and **risks & dissents** (panel objections, edge cases, potential breakages).
